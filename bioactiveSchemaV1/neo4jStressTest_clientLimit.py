...
for myIndex in range(0,int(numParallel)):
   ...
   try:
      ...
      print str(testName)+','+str(numParallel)+','+datetime.utcnow().strftime('%Y%m%d-%H%M')+','+str(outConnectTo)+','+str(rndQuery)+str(',9999')+','+str(detail)+',id:'+str(rndQueryVal)
   else:
      if showResult == "N": 
         print str(testName)+','+str(numParallel)+','+datetime.utcnow().strftime('%Y%m%d-%H%M')+','+str(outConnectTo)+','+str(rndQuery)+','+str(endTime - startTime)+',,id: "'+str(rndQueryVal)
      else: 
         print str(testName)+','+str(numParallel)+','+datetime.utcnow().strftime('%Y%m%d-%H%M')+','+str(outConnectTo)+','+str(rndQuery)+','+str(endTime - startTime)+',,id:"'+str(rndQueryVal)+'","'+str(results).replace('"','""')+'"'
